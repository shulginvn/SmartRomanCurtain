...
namespace SmartRomanCurtain
{
    class NvsMemoryManager
    {
        public:
            ...
            void SaveDataToFlash(const char* key, int32_t value);
            ...
            void SaveStrToFlash(const char* key, const char* value);

            // Designed to read data from flash memory
            int32_t ReadStrFromFlash(const char* key, const char* value);
